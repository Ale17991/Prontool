    ...
    <article className="prose prose-slate max-w-none space-y-6 text-sm leading-relaxed text-slate-700">
      <header className="space-y-1">
        ...
        <p className="text-slate-500">
          {tenant.displayName} — atualizada em maio/2026
        </p>
      </header>
      ...
      <section>
        ...
        <p>
          Os dados que você nos fornece neste formulário são tratados com o objetivo
          exclusivo de identificar você como paciente, viabilizar o agendamento da
          consulta, enviar a confirmação por email e permitir o cancelamento online
          posterior. Não usamos seus dados para marketing nem os compartilhamos com
      ...
      <section>
        ...
        <p>
          O tratamento se ampara na execução de contrato (atendimento clínico
          solicitado por você) e no seu consentimento explícito ao confirmar o
          agendamento, conforme art. 7º, V e I da Lei nº 13.709/2018 (LGPD).
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-inside list-disc">
          ...
          <li>
            Hash anonimizado do seu endereço IP (não armazenamos o IP em texto claro;
            usado apenas para limitar requisições abusivas)
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Seus dados ficam restritos ao prontuário interno da {tenant.displayName} e
          são acessíveis apenas pela equipe autorizada da clínica. O envio do email
          de confirmação usa um provedor de email transacional (Resend) — apenas as
          informações estritamente necessárias (nome, data/hora, link de cancelar)
          trafegam por esse serviço.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Mantemos seus dados pelo tempo em que você permanecer cadastrado(a) como
          paciente da clínica, observando os prazos legais aplicáveis à área da
          saúde (mínimo 20 anos para prontuário, conforme Resolução CFM nº 1.821/07).
          Os registros de tentativas de agendamento (hash de IP) são automaticamente
          apagados após 7 dias.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Você pode, a qualquer momento, solicitar à clínica:
        </p>
        <ul className="list-inside list-disc">
      ...
      <section>
        ...
        <p>
          Empregamos criptografia em trânsito (HTTPS) e em repouso para dados
          sensíveis (CPF, contato, data de nascimento). Tokens de cancelamento são
          armazenados apenas como hash SHA-256. Tentativas abusivas de agendamento
          são limitadas por nosso sistema antifraude (Cloudflare Turnstile e
