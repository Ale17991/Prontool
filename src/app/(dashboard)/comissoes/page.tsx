...
export default async function ComissoesPage() {
  ...
  if (!can(session.role, 'doctor.read')) redirect('/atendimentos')
        ...
        <CardContent className="p-0">
          {headsRes.error ? (
            ...
            <p className="px-6 pb-6 text-sm text-slate-500">
              ...
              <Link href="/medicos" className="font-semibold text-primary underline">
                Médicos
              </Link>
              .
            </p>
