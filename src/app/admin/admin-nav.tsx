...
import { Building2, DollarSign, LayoutDashboard, LifeBuoy, Stethoscope, Users } from 'lucide-react'
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? 'bg-brand-strong text-brand-foreground' : 'text-slate-600 hover:bg-slate-100',
            )}
          >
