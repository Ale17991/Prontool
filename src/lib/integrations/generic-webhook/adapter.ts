 ...
 * Pronttu team having to ship a dedicated provider.
 */
...
> = {
  ...
  description:
    'Dispara POST JSON para uma URL configurada a cada evento do Pronttu (patient.created, appointment.created, appointment.reversed).',
