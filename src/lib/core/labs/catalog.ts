...
export const LAB_ANALYTES: readonly LabAnalyteDef[] = [
  {
    ...
    unit: 'mg/dL',
    group: 'Metabolismo da Glicose',
    displayOrder: 10,
    aliases: ['Glicose em jejum'],
  },
  {
    key: 'hba1c',
  ...
  // aqui — o perfil lipídico partido em duas telas. Aparece como "sem referência".
  {
    ...
    unit: 'mg/dL',
    group: 'Perfil Lipídico',
    displayOrder: 55,
  },
  {
    key: 'lab_apo_a1',
    label: 'Apolipoproteína A-I',
    unit: 'mg/dL',
    group: 'Perfil Lipídico',
    displayOrder: 60,
    aliases: ['Apolipoproteína A-I (apo A-I)', 'Apoliproteína A'],
  },
  {
    key: 'lab_apo_b',
    ...
    group: 'Perfil Lipídico',
    displayOrder: 70,
    aliases: ['Apolipoproteína b', 'Apolipoproteína B (apo B)'],
  },
  {
    key: 'ldl',
    label: 'LDL',
    ...
    group: 'Perfil Lipídico',
    displayOrder: 80,
    aliases: ['Lipoproteína de baixa densidade (LDL)'],
  },
  {
    key: 'lab_adiponectina',
    label: 'Adiponectina',
    unit: 'mcg/mL',
    group: 'Função Cardíaca',
    displayOrder: 90,
  },
  {
    key: 'lab_coenzima_q10',
    label: 'Coenzima Q10',
    unit: 'mg/L',
    group: 'Função Cardíaca',
    displayOrder: 100,
  ...
  {
    key: 'lab_mieloperoxidase',
    label: 'Mieloperoxidase',
    unit: 'pmol/L',
    group: 'Função Cardíaca',
    displayOrder: 160,
  },
  {
    ...
    group: 'Função Cardíaca',
    displayOrder: 170,
    aliases: ['Proteína C-reativa ultrassensível (PC-R)'],
  },
  {
    key: 'triglicerides',
    label: 'Triglicérides',
  ...
  { key: 'lab_basofilos', label: 'Basófilos', unit: '%', group: 'Hemograma', displayOrder: 190 },
  {
    ...
    group: 'Hemograma',
    displayOrder: 200,
    aliases: ['Concentração de HCM (CHCM)'],
  },
  {
    key: 'lab_eosinofilos',
    label: 'Eosinófilos',
  ...
  },
  {
    ...
    group: 'Hemograma',
    displayOrder: 230,
    aliases: ['Hemoglobina corpuscular média (HCM)'],
  },
  {
    key: 'lab_hemacias',
    label: 'Hemácias (eritrócitos)',
    unit: '10⁶/mm³',
    group: 'Hemograma',
    displayOrder: 240,
  },
  ...
  {
    key: 'lab_holotranscobalamina',
    label: 'Holotranscobalamina',
    unit: 'pmol/L',
    group: 'Hemograma',
    displayOrder: 270,
  },
  {
    key: 'lab_leucocitos',
    label: 'Leucócitos (contagem diferencial)',
    unit: 'mm³',
    group: 'Hemograma',
    displayOrder: 280,
    aliases: ['Contagem diferencial de leucócitos'],
  },
  ...
  { key: 'lab_plaquetas', label: 'Plaquetas', unit: 'mm³', group: 'Hemograma', displayOrder: 320 },
  {
    ...
    group: 'Hemograma',
    displayOrder: 330,
    aliases: ['RDW (índice de anisocitose)'],
  },
  {
    key: 'lab_vcm',
    label: 'VCM',
    ...
    group: 'Hemograma',
    displayOrder: 340,
    aliases: ['Volume corpuscular médio (VCM)'],
  },
  { key: 'lab_vsg', label: 'VSG', unit: 'mm', group: 'Hemograma', displayOrder: 350 },
  {
    ...
    label: 'Ferritina',
    unit: 'mcg/L',
    group: 'Metabolismo do Ferro',
    displayOrder: 360,
  },
  {
    key: 'lab_saturacao_transferrina',
    label: 'Saturação da transferrina',
    unit: '%',
    group: 'Metabolismo do Ferro',
    displayOrder: 370,
    aliases: ['Índice de saturação da transferrina (IST)'],
  },
  {
    key: 'lab_bilirrubina_direta',
  ...
  {
    key: 'lab_fosfatase_alcalina',
    label: 'Fosfatase alcalina',
    unit: 'U/L',
    group: 'Função Hepática',
    displayOrder: 410,
    aliases: ['Fosfatase alcalina (FA)'],
  },
  {
    key: 'lab_ggt',
    label: 'GGT',
    ...
    group: 'Função Hepática',
    displayOrder: 420,
    aliases: ['Gamaglutamiltransferase (GGT)'],
  },
  {
    key: 'lab_tgo',
    label: 'TGO (AST)',
    ...
    group: 'Função Hepática',
    displayOrder: 430,
    aliases: ['Transaminase glutâmico oxaloacética (TGO)'],
  },
  {
    key: 'lab_tgp',
    label: 'TGP (ALT)',
    ...
    group: 'Função Hepática',
    displayOrder: 440,
    aliases: ['Transaminase glutâmico pirúvica (TGP)'],
  },
  {
    key: 'lab_acido_urico',
    label: 'Ácido úrico',
  ...
  {
    key: 'lab_iodo_na_urina',
    label: 'Iodo na urina',
    unit: 'mcg/L',
    group: 'Função Tireoidiana',
    displayOrder: 480,
  },
  {
    key: 'lab_iodo_salivar',
    label: 'Iodo salivar',
    unit: 'mcg/L',
    group: 'Função Tireoidiana',
    displayOrder: 490,
  ...
  },
  {
    ...
    group: 'Função Tireoidiana',
    displayOrder: 520,
    aliases: ['Tri-iodotironina (T3 total)'],
  },
  {
    key: 'lab_t4_livre',
    label: 'T4 livre (tiroxina livre)',
    unit: 'ng/dL',
    group: 'Função Tireoidiana',
    displayOrder: 530,
    aliases: ['T4 livre', 'Tiroxina livre (T4 livre)'],
  },
  {
    key: 'lab_tireoglobulina',
    label: 'Tireoglobulina',
    unit: 'ng/mL',
    group: 'Função Tireoidiana',
    displayOrder: 540,
  },
  {
    ...
    group: 'Função Tireoidiana',
    displayOrder: 550,
    aliases: ['Hormônio estimulante da tireóide (TSH)'],
  },
  {
    key: 'lab_cortisol',
    label: 'Cortisol',
    unit: 'nmol/L',
    group: 'Função Hormonal',
    displayOrder: 560,
  },
  ...
  { key: 'lab_shbg', label: 'SHBG', unit: 'nmol/L', group: 'Função Hormonal', displayOrder: 630 },
  {
    ...
    group: 'Função Hormonal',
    displayOrder: 640,
    aliases: ['Tiroxina total (T4 total)'],
  },
  {
    key: 'lab_testosterona_total',
  ...
  },
  {
    ...
    group: 'Metabolismo Ósseo',
    displayOrder: 700,
    aliases: ['25-hidroxi D3'],
  },
  {
    key: 'lab_magnesio',
    label: 'Magnésio',
    unit: 'mg/dL',
    group: 'Equilíbrio Hidreletrolítico',
    displayOrder: 710,
  },
  {
    key: 'lab_manganes',
  ...
  {
    key: 'lab_acido_folico',
    label: 'Ácido fólico',
    unit: 'ng/mL',
    group: 'Anemia Macrocíticas',
    displayOrder: 760,
  },
  {
    key: 'lab_acido_metilmalonico',
    label: 'Ácido metilmalônico',
    unit: 'mmol/L',
    group: 'Anemia Macrocíticas',
    displayOrder: 770,
  },
  {
    key: 'lab_vitamina_b12',
    label: 'Vitamina B12',
    unit: 'pg/mL',
    group: 'Anemia Macrocíticas',
    displayOrder: 780,
  ...
  {
    key: 'lab_betacaroteno',
    label: 'Betacaroteno',
    unit: 'mcg/dL',
    group: 'Marcadores de Desnutrição',
    displayOrder: 790,
  },
  {
    key: 'lab_selenio',
  ...
  {
    key: 'lab_calcio_urinario',
    label: 'Cálcio urinário',
    unit: 'mg/24h',
    group: 'Exame de Urina',
    displayOrder: 840,
  },
  {
    key: 'lab_creatinina_urinaria',
    label: 'Creatinina urinária',
    unit: 'mg/24h',
    group: 'Exame de Urina',
    displayOrder: 850,
    aliases: ['Creatinina na urina'],
  },
]
...
export const LAB_GROUPS: readonly string[] = [...new Set(LAB_ANALYTES.map((a) => a.group))]
