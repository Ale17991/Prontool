...
const styles = StyleSheet.create({
  ...
  th: { padding: 4, fontFamily: 'Helvetica-Bold', fontSize: 8, textAlign: 'center', borderRightWidth: 0.5, borderColor: '#cbd5e1' },
  td: { padding: 4, fontSize: 9, textAlign: 'center', borderRightWidth: 0.5, borderColor: '#cbd5e1' },
  ...
  const element = (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.textBlock}>OD: {d(ex.pio.od)}    OE: {d(ex.pio.oe)}</Text>

        {ex.biomicroscopy ? (<><Text style={styles.section}>Biomicroscopia</Text><Text style={styles.textBlock}>{ex.biomicroscopy}</Text></>) : null}
