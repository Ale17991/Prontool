...
function toDto(r: Record<string, unknown>): EyeglassRx {
  ...
  return {
    ...
    od: {
      sphere: g('od_sphere'),
      cylinder: g('od_cylinder'),
      axis: g('od_axis'),
      addition: g('od_addition'),
      prism: g('od_prism'),
      base: g('od_base'),
      dnp: g('od_dnp'),
    },
    oe: {
      sphere: g('oe_sphere'),
      cylinder: g('oe_cylinder'),
      axis: g('oe_axis'),
      addition: g('oe_addition'),
      prism: g('oe_prism'),
      base: g('oe_base'),
      dnp: g('oe_dnp'),
    },
...
export async function createEyeglassRx(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      od_sphere: t(input.od.sphere),
      od_cylinder: t(input.od.cylinder),
      od_axis: t(input.od.axis),
      od_addition: t(input.od.addition),
      od_prism: t(input.od.prism),
      od_base: t(input.od.base),
      od_dnp: t(input.od.dnp),
      oe_sphere: t(input.oe.sphere),
      oe_cylinder: t(input.oe.cylinder),
      oe_axis: t(input.oe.axis),
      oe_addition: t(input.oe.addition),
      oe_prism: t(input.oe.prism),
      oe_base: t(input.oe.base),
      oe_dnp: t(input.oe.dnp),
