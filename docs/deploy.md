# Deploy Checklist — Faturamento Médico GHL
...
- Domínio `homio.com.br` apontável (DNS no Cloudflare/Registro.br/…).
...
1. Resend → Add Domain → `homio.com.br`.
...
5. Sender: `alertas@homio.com.br` (ou subdomínio `no-reply@alerts.homio.com.br`
...
curl -X POST https://api.resend.com/emails \
  ...
  -d '{"from":"alertas@homio.com.br","to":["voce@homio.com.br"],"subject":"ping","text":"ok"}'
```
...
4. Env vars (Production scope — replicar no Preview se quiser PR
   ...
   | Var                            | Valor                                  |
   | ------------------------------ | -------------------------------------- |
   | `NEXT_PUBLIC_APP_URL`          | `https://app.homio.com.br`             |
