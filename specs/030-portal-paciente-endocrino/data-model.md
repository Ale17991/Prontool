...
- **Seed endócrino**: `glicemia_jejum` (mg/dL,20–600), `hba1c` (%,2–20), `circunferencia_abdominal` (cm,30–250), `colesterol_total` (mg/dL,50–800), `ldl` (mg/dL,10–600), `hdl` (mg/dL,5–200), `triglicerides` (mg/dL,20–5000). *Faixas a revisar clinicamente nas tasks.*
