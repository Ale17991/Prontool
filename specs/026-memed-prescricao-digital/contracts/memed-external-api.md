...
{ "data": { "type": "usuarios", "attributes": {
  ...
  "cpf": "<11 dígitos>",
  "board": { "board_code": "<council_name>", "board_number": "<council_number>", "board_state": "<council_state UF>" },
  "data_nascimento": "<dd/mm/YYYY>",
  "email": "<opcional>", "telefone": "<opcional>", "sexo": "<M|F opcional>",
  "especialidade": "<memed_specialty_id opcional>", "cidade": "<id cidade opcional>"
}}}
```
