...
- **Protegidas (NÃO-overridáveis por padrão — Princípio V)**: `price.write`, `commission.write`, `appointment.reverse`, `audit.read`, `audit.export`. *(Sujeito à decisão do stakeholder — ver plan §Complexity Tracking.)*
